...
class Ccontrol_Admin_Budget_PDF
{
     ...
     *
     * @param array $arr_data [Current Budget array]
    ...
    public function ccontrol_pdf_first_page($arr_data, $pdf)
    {
        ...
        $pdf->Cell(0, 0, mb_convert_encoding(esc_attr__('PRESUPUESTO WEB', 'ccontrol'), 'ISO-8859-1', 'UTF-8'), 0, 1, 'C');
        $pdf->SetXY(0, 170);
    ...
    public function ccontrol_pdf_top_page($arr_data, $pdf)
    {
        ...
        $pdf->Cell(0, 0, mb_convert_encoding(esc_attr__('PRESUPUESTO WEB', 'ccontrol'), 'ISO-8859-1', 'UTF-8'), 0, 1, 'L');
    }
    ...
    public function ccontrol_pdf_second_page($arr_data, $pdf)
    {
        $pdf->SetXY(10, 25);
        $pdf->SetFont('Helvetica', 'B', 16);
        $pdf->Cell(0, 0, mb_convert_encoding(esc_attr__('Datos del Proyecto', 'ccontrol'), 'ISO-8859-1', 'UTF-8'), 0, 1, 'L');
        $pdf->SetXY(10, 40);
        $pdf->SetFont('Helvetica', '', 12);
        $pdf->Cell(0, 0, mb_convert_encoding(esc_attr__('Nombre: ', 'ccontrol') . $arr_data['client'], 'ISO-8859-1', 'UTF-8'), 0, 1, 'L');
        $pdf->SetXY(10, 50);
        $pdf->SetFont('Helvetica', '', 12);
        ...
        $pdf->SetXY(10, 80);
        $pdf->SetFont('Helvetica', 'B', 16);
        $pdf->Cell(0, 0, mb_convert_encoding(esc_attr__('Detalles del Proyecto', 'ccontrol'), 'ISO-8859-1', 'UTF-8'), 0, 1, 'L');
        $pdf->SetXY(10, 90);
        $pdf->SetFont('Helvetica', '', 12);
        ...
        $pdf->SetXY(20, 185);
        $pdf->SetFont('Helvetica', 'B', 16);
        $pdf->Cell(0, 0, mb_convert_encoding(esc_attr__('Te ofrezco lo siguiente:', 'ccontrol'), 'ISO-8859-1', 'UTF-8'), 0, 1, 'L');
        $pdf->SetXY(20, 195);
        $pdf->SetFont('Helvetica', '', 12);
    ...
    public function ccontrol_pdf_third_page($arr_data, $pdf)
    {
        ...
        $pdf->SetXY(10, 25);
        $pdf->SetFont('Helvetica', 'B', 16);
        $pdf->Cell(0, 0, mb_convert_encoding(esc_attr__('Costo del Proyecto', 'ccontrol'), 'ISO-8859-1', 'UTF-8'), 0, 1, 'L');
        ...
        $pdf->Cell($w[0], 9, '  ' . mb_convert_encoding(esc_attr__('Total', 'ccontrol'), 'ISO-8859-1', 'UTF-8'), 'LR', 0, 'L', $fill);
...
El código del proyecto estará considerado a ser expuesto en los perfiles de trabajo de Robert Ochoa (entiéndase perfiles de trabajo como Github / Linkedin / Behance y otros sitios de resentación de trabajos), los cuales el proyecto aplique.';
        ...
        $pdf->SetXY(10, 25);
        $pdf->SetFont('Helvetica', 'B', 16);
        $pdf->Cell(0, 0, mb_convert_encoding(esc_attr__('Condiciones del Proyecto', 'ccontrol'), 'ISO-8859-1', 'UTF-8'), 0, 1, 'L');
     ...
     * @param string $output [Signal to export in different format]
     *
     * @return string|void
     */
